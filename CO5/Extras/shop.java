// A company advertises various products in its website to sell. Products can be either electronics, clothes,  jewellery, cosmetics, books ,stationery ,sport s items etc. Offer Zone class shows products with discounts, special offers etc. Price, Brand of product should be listed along with category and name of the product, when user specifies name of product. Implement the above scenario using java concepts like interface, inheritance(use multilevel inheritance with minimum 4 levels along with other types of inheritance),exception handling.
